...
<main class="p-16px md:px-offset-md w-full">
    <div id="wrapper" class="grid grid-cols-1 md:gap-x-2% md:grid-cols-4 gap-y-6">
        ...
        <div class="md:col-start-1 md:py-0 md:row-span-2 row-start-2 md:col-start-1 mt-6">
            <div class="w-full grid grid-cols-2 bg-white shadow md:shadow-lg md:place-items-center h-408px xl:h-537px md:h-580px pt-3">
        ...
        <div class="row-start-3 bg-white grid md:grid-cols-40-60 grid-col-1 gap-x-6 p-5 md:col-start-2 md:col-end-5 md:grid-row-2">
            <div class="md:col-span-2 mt-5 col-start-1">
            ...
            <div class="flex flex-row col-start-1">
                <div class=" w-full flex-row flex items-center">
                    <div class="relative w-full">
                        <img src="../images/1.png " alt="" class="object-cover w-full">
                        <div class="h-2 absolute bottom-0 right-0 z-10 bg-red-800 w-full"></div>
                        <img src="../svgs/podcast-2-big.svg" alt="Podcast icon" class="absolute bottom-2 right-3 rounded-lg">
                    </div>
                </div>
            </div>
            <div class="flex flex-col md:col-start-2 justify-center  col-start-1">
                <div class="flex flex-row items-center">
                    <div class="w-4 h-1 bg-black-700 ml-3"></div>
                ...
                <div class="flex flex-row mt-8">
                    <button class="flex flex-row bg-black-100 py-1 px-4 items-center rounded-full">
                        <i class="icon-play text-s-1 text-red-800 ml-3"></i>
            ...
            <div class="md:col-span-2 h-14 w-full bg-white col-start-1"></div>
