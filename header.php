<div class="bg-white">
    ...
    <div class="fixed top-0 w-full bg-black-200">
        <div class="w-full h-40 ">
            <div class="grid grid-cols-3 h-16 bg-white w-full">
                ...
                <div class="col-start-3 flex flex-row items-center justify-end">
                    <i class="icon-close text-24px p-3"></i>
                </div>
            </div>
            <div class="mt-5 h-full w-full bg-white static">
                <div class="border-2 border-black-300 rounded-full">
                    <div class="flex flex-row">
                        <i class="icon-search_24px text-24px ml-4"></i>
